    ...
    <header>
        ...
        <div class="banniere">
            ...
            <div class="boutons-banniere">
                ...
                <a class="fill-button" href="<?=(empty($_SESSION['firstname']))? A_LINK['login_client'] : '#/cart';?>"><span class="fill-button-hover"><span class="fill-button-text"><i class="fas fa-shopping-cart logo-panier"><sup class="count-product"><span class="<?=(empty($_SESSION['firstname']))? '' : 'snipcart-items-count';?>"></sup></span></i></span></span></span></a>
                <p></p>
            </div>
