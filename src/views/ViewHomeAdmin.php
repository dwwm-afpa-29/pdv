<div class = "homeAdmin">
    ...
    <div class = "titre-home-admin">
        ...
        <div class = "historical-home-admin"><a href="https://app.snipcart.com/dashboard/orders" class = "Button29 slide_inside">Historique des commandes</a></div>
        ...
        <div class = "modif-home-admin"><a href="<?= A_LINK['customer_profile']; ?>" class = "Button29 slide_inside">Modifier mon profil</a></div>
